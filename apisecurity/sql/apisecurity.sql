...
CREATE TABLE jdbc_customer (id INT generated BY DEFAULT AS IDENTITY PRIMARY key, full_name VARCHAR(50), email VARCHAR(50) NOT NULL UNIQUE, birth_date DATE, gender VARCHAR(50) );
INSERT INTO
...
CREATE TABLE jdbc_merchant ( id INT generated BY DEFAULT AS IDENTITY PRIMARY key, merchant_name VARCHAR(50), email VARCHAR(50), description text );
INSERT INTO
...
AS $BODY$
begin
update jdbc_customer set full_name = new_full_name where id = existing_id;
end
$BODY$;
-----
DROP TABLE IF EXISTS jpa_customer;
CREATE TABLE jpa_customer ( id INT generated BY DEFAULT AS IDENTITY PRIMARY key, full_name VARCHAR(50), email VARCHAR(50) NOT NULL UNIQUE, birth_date DATE, gender VARCHAR(50) );
INSERT INTO
...
CREATE TABLE basic_auth_user ( id INT generated BY DEFAULT AS IDENTITY PRIMARY key, username VARCHAR(150) NOT NULL UNIQUE, password_hash VARCHAR(100) NOT NULL, salt VARCHAR(16) NOT NULL UNIQUE, display_name VARCHAR(50) );
INSERT INTO
  basic_auth_user (id, username, password_hash, salt, display_name)
VALUES
  (
...
;
DROP TABLE IF EXISTS basic_api_key;
CREATE TABLE basic_api_key(api_key_id INT generated BY DEFAULT AS IDENTITY PRIMARY key, user_id INT, api_key VARCHAR(64) NOT NULL UNIQUE, expires_at TIMESTAMP WITHOUT TIME zone);
INSERT INTO
  basic_api_key(user_id, api_key, expires_at)
VALUES
  (
...
--DROP TABLE IF EXISTS basic_auth_user;
--CREATE TABLE basic_auth_user (id INT generated BY DEFAULT AS IDENTITY PRIMARY key, username VARCHAR(128) NOT NULL UNIQUE, password_hash VARCHAR(128), salt VARCHAR(64), display_name VARCHAR(64));