...
CREATE TABLE customer ( id INT generated BY DEFAULT AS IDENTITY PRIMARY key, full_name VARCHAR(50), email VARCHAR(50) NOT NULL UNIQUE, birth_date DATE, gender VARCHAR(50) );
INSERT INTO
  customer (full_name, email, birth_date, gender) 
VALUES
  (
...
CREATE TABLE merchant ( id INT generated BY DEFAULT AS IDENTITY PRIMARY key, merchant_name VARCHAR(50), email VARCHAR(50), description text );
INSERT INTO
  merchant (merchant_name, email, description) 
VALUES
  (
...
begin
    dynamic_sql = 'update customer set full_name = ''' || new_full_name 
...
AS $BODY$
begin
update customer set full_name = new_full_name where customer_id = existing_customer_id
end
$BODY$;
-----
